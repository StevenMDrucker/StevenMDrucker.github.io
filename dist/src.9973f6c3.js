...
var researchData_json_1 = __importDefault(require("../data/researchData.json"));
var app = React.createElement("section", null, " Hello Steven! ", researchData_json_1.default[0].booktitle);
ReactDOM.render(app, document.getElementById('app'));
},{"react":4,"react-dom":5,"../data/researchData.json":6}],9:[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '34516' + '/');
